...
export const pageReports = sqliteTable(
  "page_reports",
  {
    id: id(),
    pageId: text("page_id")
    ...
    judgments: text("judgments", { mode: "json" }).notNull(),
    rules: text("rules", { mode: "json" }).notNull(),
    fixes: text("fixes", { mode: "json" }).notNull(),
 ...
 */
export const pageDecisions = sqliteTable(
  "page_decisions",
  {
    id: id(),
    pageId: text("page_id")
    ...
    probabilities: text("probabilities", { mode: "json" }).notNull(),
...
export const cannibalPairs = sqliteTable(
  "cannibal_pairs",
  {
    id: id(),
    projectId: text("project_id")
